...
class VaastuCameraViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, CLLocationManagerDelegate, UIGestureRecognizerDelegate {
...
//    imagePickerVasastu!.allowsEditing = false
//        imagePickerVasastu!.allowsEditing = false
//        
//        
